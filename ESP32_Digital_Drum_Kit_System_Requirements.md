...
> ⚠️ Note: Avoid GPIO 6–11 (used internally by flash), GPIO 34–39 are input-only.
...
*Document Version: 1.0 | Project: Audio Equipment using ESP32 | Platform: ESP32-M1 DevKit*
